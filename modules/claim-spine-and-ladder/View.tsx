    ...
    <section className="space-y-10">
      ...
      <div>
        <h3 className="font-mono text-xs font-semibold uppercase tracking-widest text-faint">
          Where it stood at the end of the week
        </h3>
      ...
      <div>
        <h3 className="font-mono text-xs font-semibold uppercase tracking-widest text-faint">
          Three decisions that are still holding
        </h3>
          ...
          {decisions.map((d) => (
            ...
            >
              <div className="flex items-baseline gap-3">
                <span className="font-mono text-xs text-faint">{d.n}</span>
                <h4 className="text-base font-semibold leading-snug">{d.title}</h4>
              </div>
              <p className="mt-2 text-sm text-muted">{d.matters}</p>
              <p className="mt-3 border-l-2 border-border pl-3 text-sm">{d.cost}</p>
              <p className="mt-3 font-mono text-xs text-faint">{d.tail}</p>
            </div>
          ))}
        </div>
      </div>
