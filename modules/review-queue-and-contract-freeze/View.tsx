...
export default function View() {
  return (
    <section className="space-y-10">
      <div>
        <p className="font-mono text-xs uppercase tracking-widest text-faint">Queue and contract</p>
      ...
      <div>
        <SectionTitle>Who may do what</SectionTitle>
        <div className="mt-3">
          <Matrix />
        </div>
      </div>
      ...
      <div>
        <SectionTitle>What the frozen contract is made of</SectionTitle>
        <div className="mt-3">
          <Cases />
        </div>
      </div>
      ...
      <div>
        <SectionTitle>Three things that made it worth trusting</SectionTitle>
        <div className="mt-3 space-y-3">
          {points.map((p) => {
            const Icon = cardIcon[p.icon as keyof typeof cardIcon];
            return (
              <div
                key={p.n}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <span className="ml-auto font-mono text-xs text-faint">{p.n}</span>
                </div>
